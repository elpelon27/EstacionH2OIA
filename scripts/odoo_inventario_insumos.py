...
async def get_insumos_inventory() -> dict:
    ...
    try:
        ...
        # Construir domain OR para búsqueda
        domain = []
        ...
        products = odoo.execute_kw("product.product", "search_read", [domain], {
            "fields": ["name", "qty_available", "virtual_available", "uom_id", "categ_id", "standard_price", "list_price", "type"]
        })
