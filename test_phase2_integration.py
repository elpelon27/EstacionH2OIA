...
from orchestration import AgentType, Orchestrator, SkillRegistry
...
def test_phase2_integration():
    ...
    print("   ✅ Cross-agent memory: Financial agent retrieved dispatcher's route plan")
    ...
    async def test_handoff():
        ...
        print("   ✅ Handoff: dispatcher -> inventory successful")
