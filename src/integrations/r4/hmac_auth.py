...
if __name__ == "__main__":
    ...
    print(f"Verify OK: {verify_hmac_signature(payload_bcv, R4Endpoint.R4BCV, expected, COMMERCE_TOKEN)}")
    print(f"Verify FAIL: {verify_hmac_signature(payload_bcv, R4Endpoint.R4BCV, 'INVALID', COMMERCE_TOKEN)}")