...
class CodigosRedInterbancaria(str, Enum):
    ...
    def is_success(cls, code: str) -> bool:
        ...
        success_codes = {
            "00", "ACCP", "C2P_00", "C2P_ANUL_00", "VUELTO_00", "DOM_202",
            "C2P_BANCO_00"
        }
    ...
    def is_retryable(cls, code: str) -> bool:
        ...
        retryable_codes = {
            "05", "87", "68", "AB01", "TM01", "ED05", "DS02", "DU01"
        }
    ...
    def is_client_error(cls, code: str) -> bool:
        ...
        client_errors = {
            "01", "12", "13", "14", "15", "30", "41", "43", "51", "55", "56", "57",
            "62", "80", "87", "90", "91", "92", "99",
            "AC01", "AC04", "AC06", "AC09", "AB07", "AG01", "AG09", "AG10",
            "AM02", "AM04", "AM05", "BE01", "BE20", "CH20", "CUST",
            "DT03", "FF05", "FF07", "MD01", "MD09", "MD15", "MD21", "MD22",
            "RC08", "RJCT", "TKCM", "VE01",
            "C2P_08", "C2P_15", "C2P_30", "C2P_41", "C2P_51", "C2P_56", "C2P_80",
            "C2P_ANUL_41",
            "VUELTO_08", "VUELTO_14", "VUELTO_51", "VUELTO_55", "VUELTO_56", "VUELTO_80",
            "DOM_07", "DOM_11",
            "C2P_BANCO_08", "C2P_BANCO_15", "C2P_BANCO_30", "C2P_BANCO_41", "C2P_BANCO_51", "C2P_BANCO_56", "C2P_BANCO_80",
            "C2P_ANUL_41",
        }
...
DESCRIPCIONES_CODIGOS = {code: CodigosRedInterbancaria.get_description(code) for code in CODIGOS_RED}
...
if __name__ == "__main__":
    ...
    # Test some codes
    test_codes = ["00", "01", "05", "12", "13", "14", "30", "41", "51", "55", "56", "80", 
                  "ACCP", "AC00", "AC01", "C2P_00", "C2P_51", "VUELTO_00", "DOM_202"]
    ...
    for code in test_codes:
        ...
        print(f"  {code:12} | {'✓' if success else '✗'} | {'⟳' if retryable else '  '} | {'!' if client_err else ' '} | {desc}")
