...
class R4ConsultaRequest(BaseModel):
    ...
    Monto: Optional[str] = Field(None, description="Monto de la operación - máx 8 números y 2 decimales")
    TelefonoComercio: Optional[str] = Field(None, description="Teléfono del comercio - 11 numérico")
...
class R4NotificaRequest(BaseModel):
    ...
    TelefonoComercio: str = Field(..., description="Teléfono del comercio (requerido) - 11 numérico")
    TelefonoEmisor: str = Field(..., description="Teléfono de origen del pago (requerido) - 11 numérico")
    Concepto: Optional[str] = Field(None, description="Motivo del pago (opcional) - 30 alfanumérico")
    ...
    CodigoRed: str = Field(..., description="Código de respuesta de la red interbancaria (requerido) - String")
...
class R4PagosPersona(BaseModel):
    ...
    montoPart: str = Field(..., description="Monto parcial a repartir al beneficiario")


class R4PagosRequest(BaseModel):
    monto: str = Field(..., description="Monto total para la dispersión - máx 8 números y 2 decimales")
...
class R4VueltoRequest(BaseModel):
    ...
    Monto: str = Field(..., description="Monto con decimales separados por punto - máx 8 números y 2 decimales")
    Concepto: Optional[str] = Field("PRUEBA", description="OPCIONAL - Motivo del pago - 30 alfanumérico")
    Ip: Optional[str] = Field("0.0.0.0", description="OPCIONAL - IP de la máquina - 8 numérico")
...
def get_reference(response: R4BaseResponse) -> Optional[str]:
